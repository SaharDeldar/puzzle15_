    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                for (int j = 0; j < 4; j++)
                {
                    if (a[index] == 16)
                    {
                        Dynamicbutten[i, j].Hide();
                        em_x = i;
                        emt_y = j;
                    }
                    Dynamicbutten[i, j].Text = Convert.ToString(a[index]);
                    Dynamicbutten[i, j].Font = new Font("Arial", 20);
                    index++;
                }
            }
        ...
        private void button16_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                for (int j = 0; j < 4; j++)
                {
                    if(Dynamicbutten[i,j]==this_button)
                    {
                        x = i;
                        y = j;
                    }
            ...
            if(
                ...
                {
                Dynamicbutten[em_x, emt_y].Text = this_button.Text;
                this_button.Text = "16";
                Dynamicbutten[em_x, emt_y].Show();
                this_button.Hide();
                em_x = x;
                emt_y = y;
            }
